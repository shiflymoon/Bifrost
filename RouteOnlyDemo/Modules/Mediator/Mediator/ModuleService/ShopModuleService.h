...
//UIKIT_EXTERN NSNotificationName kNotification*** ;

#pragma mark - URL ViewController routers
UIKIT_EXTERN NSString *const kRouteShopDetail ;

#pragma mark - URL Service routers
UIKIT_EXTERN NSString *const kRouteShopName ;
UIKIT_EXTERN NSString *const kRouteShopLogo ;
UIKIT_EXTERN NSString *const kRouteShopRevenue ;

#pragma mark - URL Model Key Define
